...
function Info(props) {
    return(
        ...
        <div className="px-6 py-4">
            ...
            className='text-gray-700 text-base'>{props.title}</span>
            </div>
            <div><strong>Channel Title: </strong><span
            className='text-gray-700 text-base'>{props.channelTitle}</span>
            </div>
            <div><strong>Views: </strong><span
            className='text-gray-700 text-base'>{props.views}</span>
            </div>
        </div>
    </div>
    )
